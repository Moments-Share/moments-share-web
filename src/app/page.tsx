            ...
            {businesses.map((b, i) => (
              <div key={b.label} className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
                ...
                <div className={`md:col-span-6 ${i % 2 === 1 ? "md:order-1" : ""}`}>
                  ...
                  <Link href={b.href} className="mt-6 inline-block text-[14px] font-bold text-green border-b border-green/60 pb-0.5 hover:text-terra hover:border-terra transition-colors">
                    {b.label}を詳しく →
                  </Link>
                </div>
              </div>
      ...
      <section className="py-16 md:py-28 px-6 md:px-10 bg-white">
        <div className="mx-auto max-w-[1400px]">
          <div className="flex flex-wrap items-end justify-between gap-4">
            ...
            <Link href="/works" className="text-[14px] font-bold text-green border-b border-green/60 pb-0.5 hover:text-terra hover:border-terra transition-colors">実績をもっと見る →</Link>
          </div>
        ...
        <div className="mx-auto max-w-[1400px]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
            <div className="lg:col-span-5 order-2 lg:order-1">
              ...
              <Link href="/people" className="mt-7 inline-block text-[14px] font-bold text-green border-b border-green/60 pb-0.5 hover:text-terra hover:border-terra transition-colors">
                関わる人たちを見る →
              </Link>
            </div>
